...
class ImageProcessingApi {
  ...
  // static Future<String> recogniseText(WriteBuffer bytes, InputImageData inputImageData) async {
  //   if (inputImageData == null) {
  //     return "No selected image";
  //   } else {
  //     final visionImage = InputImage.fromBytes(bytes: bytes.done().buffer.asUint8List(), inputImageData: inputImageData);
  //     final textRecognizer = GoogleMlKit.vision.textDetector();
